...
<li><a href="#">Modificar</a></li>
      ...
      <td>
      <div >
       <form  name="consultac" method="post" action="resultequi1.php">
   			 <fieldset id="quequieresconsultar">
    		<legend align="center">
    		¿Que quieres consultar?
    		</legend>
		 <div align="center"><label> Equipo:</label> <select name="equipo" id="equipo"><?php echo $opciones; ?></select>  
		...
		<option value="0">Elige un equipo primero</option>
            ...
            <input type="submit" value="Consulta seleccionada" name="consulta1"/>
            <a href="resultasis2.php"> <input type="submit" value="Consultar todos los equipos" name="consulta2" /></a> </div></fieldset></form>
            </div>
            </div>
    </body>
</html>