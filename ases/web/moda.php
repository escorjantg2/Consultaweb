...
<li>
  <div align="left"><a href="#">Notas</a>
    <ul>
      ...
      <td>
      <div >
       <form  name="consultaa" method="get" action="insertarasistencia.php">
        ...
        <label> Fecha:</label><input type="text" name="fecha" value="<?php echo $fecha ?>"/>
        <div align="center"></div>
        <input type="submit" value="Ir a hoja de control de asistencias" name="insertarasistencias" /></div></fieldset></form>		</form>
            </div>
            </div>
    </body>
</html>
