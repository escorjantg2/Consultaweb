...
<li>
  <div align="left"><a href="#">Notas</a>
    <ul>
      ...
      <td>
      <div >
       <form  name="consultaa" method="get" action="resultasis1.php">
        ...
        <div>
         <label> Fecha (calendario pendiente):</label><input type="text" name="fecha" value="<?php echo $fecha ?>"/>
    	</div>
        <div align="center"></div>
            <input type="submit" value="Consulta seleccionada" name="consulta1"/>
            <a href="resultasis2.php"> <input type="submit" value="Consultar alumnos con faltas/retrasos" name="consulta2" /></a> </div></fieldset></form>
            </div>
            </div>
    </body>
</html>